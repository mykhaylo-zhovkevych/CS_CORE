...
namespace ConsoleAppTest4._1
{
    ...
    public class StackStorageTest
    {
        ...
        // internal constrct ofthe c# non needed to test
        [TestMethod]
        public void TestStackStorage_WithDifferentDataTypes()
        {
            // Arrange & Act
            for (int i = 1; i <= 5; i++)
            {
        ...
        public void TestStackStorage_WhenStackSize_IsOveraken()
        {
            ...
            // Assert & Act
            Assert.ThrowsException<StackExceptions.StackFullException>(() => _cellarInt.Push(10));
        }
